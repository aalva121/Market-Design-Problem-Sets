...
\textbf{Key insight:} Failures can come from \textbf{market rules}, not only market power.
\vspace{0.35cm}

\textbf{A practical checklist (what to diagnose):}
\begin{itemize}
  \item \textbf{Participation:} Is the market thick enough, or do agents stay out?
  \item \textbf{Timing:} Is there \textbf{unraveling} (early contracting) or congestion?
  \item \textbf{Incentives:} Do rules induce \textbf{misreporting} or rent-seeking?
  \item \textbf{Information:} Are preferences/quality signals aggregated effectively?
\end{itemize}

\vspace{0.35cm}
\textbf{Example (unraveling):} In decentralized labor markets, early offers can lock in
matches before full information is available, lowering overall match quality.
\end{frame}
